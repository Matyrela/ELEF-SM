...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Ingresa nombre de usuario.";
    } else{
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $login_err = "Nombre o contraseña no valida.";
                        }
                    }
                } else{
...
<div class="sidenav">
         <div class="login-main-text">
            <h1>ELEF-SM</h1><h2> Iniciar sesión</h2>
            <p>Portal web de ELEF-SM.</p>
         </div>
      </div>
      <div class="main">
            ...
            ?>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                  <div class="form-group">
                     ...
                     <input type="text" name="username" class="form-control" <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?> value="<?php echo $username; ?>" placeholder="Nombre de usuario">
